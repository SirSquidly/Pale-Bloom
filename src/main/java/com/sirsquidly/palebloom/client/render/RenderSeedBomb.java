...
public class RenderSeedBomb extends Render<EntitySeedBomb>
{
    public RenderSeedBomb(RenderManager renderManagerIn)
    {
        super(renderManagerIn);
        this.shadowSize = 0.5F;
    }

    public void doRender(EntitySeedBomb entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        else if (entity.getFuse() / 5 % 2 == 0)
        {
            ...
            blockrendererdispatcher.renderBlockBrightness(getTNTBlockState(), 0.5F);
    ...
    { return JTPGBlocks.SEED_BOMB.getDefaultState(); }

    protected ResourceLocation getEntityTexture(EntitySeedBomb entity)
