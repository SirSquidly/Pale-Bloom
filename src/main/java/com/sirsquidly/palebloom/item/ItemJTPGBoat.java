...
import com.sirsquidly.palebloom.entity.item.EntityPaleBoat;
 ...
 */
public class ItemJTPGBoat extends Item
{
    public ItemJTPGBoat()
    {
        this.maxStackSize = 1;
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                EntityPaleBoat entityboat = new EntityPaleBoat(worldIn, raytraceresult.hitVec.x, flag1 ? raytraceresult.hitVec.y - 0.12D : raytraceresult.hitVec.y, raytraceresult.hitVec.z);
