...
public class ItemPaleSword extends ItemSword
{
    ...
    public Multimap<String, AttributeModifier> getItemAttributeModifiers(EntityEquipmentSlot slot)
    {
        ...
        if (slot == EntityEquipmentSlot.MAINHAND)
        {
            if (isNight)
            {
                ...
                multimap.put( SharedMonsterAttributes.ATTACK_DAMAGE.getName(), new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Night sword damage", 5.0D, 0));
            }
        }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        if (isNight)
        {
            ...
            tooltip.add(TextFormatting.GRAY + I18n.format("description.palebloom.cultivar_item.night_damage"));
            tooltip.add(TextFormatting.GRAY + I18n.format("description.palebloom.cultivar_item.night_repair"));
            tooltip.add(TextFormatting.GRAY + I18n.format("description.palebloom.cultivar_sword.night"));
        }
        else
