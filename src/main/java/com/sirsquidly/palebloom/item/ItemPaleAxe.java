...
public class ItemPaleAxe extends ItemAxe
{
    ...
    {
        if (state.getBlock() instanceof BlockLog && !entityLiving.isSneaking())
        {
            if (entityLiving instanceof EntityPlayer)
            {
                ...
                ((EntityPlayer)entityLiving).getCooldownTracker().setCooldown(stack.getItem(), 50);
            }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        if (isNight)
        {
            ...
            tooltip.add(TextFormatting.GRAY + I18n.format("description.palebloom.cultivar_axe.night"));
        }
        else
