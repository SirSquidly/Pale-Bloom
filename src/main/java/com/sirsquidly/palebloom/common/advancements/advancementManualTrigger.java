...
public class advancementManualTrigger implements ICriterionTrigger
{
    private final ResourceLocation id;
    private final Map<PlayerAdvancements, Set<Listener>> listeners = Maps.newHashMap();
    
    public advancementManualTrigger(String name) {
        id = new ResourceLocation(paleBloom.MOD_ID, name);
    }
